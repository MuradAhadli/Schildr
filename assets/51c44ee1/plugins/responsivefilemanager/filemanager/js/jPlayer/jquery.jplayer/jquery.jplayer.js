...
(function (root, factory) {
	...
	// Reserved event names generated by jPlayer that are not part of the HTML5 Video element spec
	...
	$.jPlayer.prototype = {
		...
		options: { // Instanced in $.jPlayer() constructor
			...
			noConflict: "jQuery",
			emulateHtml: false, // Emulates the HTML5 Video element on the jPlayer element.
			errorAlerts: false,
			warningAlerts: false
		},
		optionsAudio: {
...
*/
		...
		_init: function() {
			...
			// Create the bridge that emulates the HTML Video element on the jPlayer DIV
		...
		jPlayerFlashEvent: function(eventType, status) { // Called from Flash
			if(eventType === $.jPlayer.event.ready) {
				if(!this.internal.ready) {
					...
					// Only do this if the Flash is the solution being used at the moment. Affects Video players where both solution may be being used.
					if(this.flash.gate) {
	...
	$.jPlayer.errorMsg = {
		...
		URL: "Video URL could not be loaded.", // Used in: jPlayerFlashEvent() and _addHtmlEventListeners()
