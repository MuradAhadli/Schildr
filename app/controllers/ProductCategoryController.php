...
class ProductCategoryController extends Controller
{
    ...
    public function actionIndex()
    {
        ...
        $productCategories = ProductCategory::getProductCategory(0, null, null);
    ...
    public function actionCategoryIn($id)
    {
        ...
        $clients = Clients::getAllClients();
        $partners = Partners::getPartners();
        $productCategory = ProductCategory::getProductCategoryByProductId($id);
        $productCategories = ProductCategory::getProductCategory(0);
        $products = Product::getProduct($id);
        $carousel = Carousel::getCarouselByCategory($productCategory['id']);
