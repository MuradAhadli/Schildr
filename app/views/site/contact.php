        ...
        <div class="page_title pb-0 pl_992_0" style="padding: 0;">
            <div class="main-center">
                <div class="col-md-8" style="border-top: 1px solid #7396ae;  padding-left: 0;">
                    <h1 class="text-uppercase" style="font-size: 45.7px; font-family: 'Barlow', sans-serif; font-weight: normal; color: #232323; margin-top: 30px;"><?= yii::t('db', 'Contact us') ?></h1
                    <h4>
                        <?= $pageName['short'] ?>
                    </h4>
                </div>
    ...
    <div class="inner_main_center for_about border_1">
        ...
        <div class="row contact_form">
            ...
            <div class="col-md-6">
                ...
                <div class="form-group">
                        <textarea class="form-control" name="message" required id="" cols="30" rows="7"
            ...
            <div class="container-fluid row" style=" margin-top: 20px">
                <div class="col-md-3">
                    ...
                    <div class="form-group checkbox_item">
                        ...
                        <label for="morning" class="label_span no-select">Morning: 09:00 am - 1:00 pm</label><br>
                        <input type="checkbox" name="afternoon" id="afternoon" value="afternoon">
                        <label for="afternoon" class="label_span no-select">Afternoon: 01.00 pm - 05:00 pm</label>
                    </div>
                </div>
<!--                <div class="col-md-6">-->
...
<!--                </div>-->
        ...
        <div class="row contacts_helper">
            <?php foreach ($address as $key => $val) : ?>
                <!--First item-->
                <div class="col-md-6 col-lg-6 contacts_item" id="contact-<?=$val['id']?>">
                    <div class="contacts_item__header">
                        <div class="item__header___flag">
                            <div class="left">
                            <span>  
                                <img class="img-responsive"
                                     src="<?= yii::getAlias('@web') . $val['image'] ?>" alt="<?= $val['title'] ?>">
                            </span>
                                <span><?= $val['title'] ?></span>
                            </div>
                            <div class="right">
                            <span>
                                <img src="<?= yii::getAlias('@web') . '/app/media/img/contacts/location.svg' ?>" alt="Location">
                            </span>
                        ...
                        <div class="contacts_item__body">
                            ...
                            <p>T.: <?= $val['phone'] ?></p>
                            <p>email: <a  href="mailto:schildr.marketing@gmail.com"><?= $val['email'] ?> </a></p>
    ...
    <div class="title" >
        <div class="page_title_prd" style="padding-left: 18px !important;">
            <div class="col-md-5 text-uppercase" style="border-top: 1px solid #7396ae;  padding-left: 0;">
                <h1 class="text-uppercase" style="font-size: 45.7px; font-family: 'Barlow', sans-serif; font-weight: normal; color: #232323; margin-top: 30px; margin-left: 0 !important;"><?= yii::t('db', 'OUR SHOWROOMS') ?></h1>
            </div>
        </div>
    </div>
