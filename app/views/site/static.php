...
$this->title =  $page['title']. " - Schildr Outdoor Solution, New Jersey ";
...
<div class="container-fluid main_top">
    ...
    <div class="carousel" style="height: 47.5vh;">
        ...
        <div class="bg_top"
             style="background-image:  linear-gradient(to bottom, #000000 -24%, #ffffff00 35%), url(<?= yii::getAlias('@web') . $page['image']?>)">
            <div class="bg_layer">
