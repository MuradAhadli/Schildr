            ...
            <div class="carousel_right_zone_inner">
                <ul>
                    <?php foreach ($productCategories as $item): ?>
                        <li><a href="<?= Url::to(['product-category/view', 'page_slug' => 'product', 'slug' => $item['slug'], 'id' => $item['id']]) ?>"><?= $item['title'] ?></a></li>
                    <?php endforeach; ?>
                </ul>
            </div>
    ...
    <div class="inner_main_center">
        ...
        <div class="main_center">
            <div class="col-md-4 text-uppercase" style="border-top: 1px solid #7396ae;  padding-left: 0;">
                <h1 class="text-uppercase" style="font-size: 45.7px; font-family: 'Barlow', sans-serif; font-weight: normal; color: #232323; margin-top: 30px;"><?= yii::t('db', 'PRODUCTS') ?></h1>
            </div>
