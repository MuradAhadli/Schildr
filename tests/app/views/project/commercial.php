...
$type = \app\controllers\ProjectController::COMMERCIAL_TYPE;
...
$this->title = $commerTitle[0] . " » " . $pageName[3]['title'] . " » " . $site;
...
<div class="container-fluid main_top">
    ...
    <div class="carousel">
        ...
        <div class="main_menu_left">
            <div class="menu_inner no-select">
                <ul>
                    <li><a href="<?= Url::to(['site/about-us', 'page_slug' => 'about-us']) ?>">ABOUT US</a></li>
                    <li>
                        <span class="nav-list-parent <?= ($controller == 'project') ? 'hide_child' : 'show_sub_menu'; ?>">
                            PROJECTS
                            <span>
                                <i class="fas fa-chevron-right ml-18"></i>
                            </span>
                        </span>
                        <ul class="menu_child <?= ($controller == 'project') ? 'show' : ''; ?>">
                            <li><a href="<?= Url::to(['project/recidental']) ?>">residential</a></li>
                            <li class="<?= ($action == 'commercial') ? 'active_link' : '' ?>"><a
                                        href="<?= Url::to(['project/commercial']) ?>">commercial</a></li>
                        </ul>
                    </li>
                    <li>
        ...
        <div class="page_title">
            <div class="row">
                ...
                <div class="col-lg-7 col-md-8">
                    <h4 class="text-uppercase"><?= $commercialTitle ?></h4>
                    <p>
                        <?= $commercialDesc; ?>
        ...
        <div class="project project_org border_1">
            <div id="lightgallery">
                <div class="row contain-group">
                    ...
                    <div class="col-md-6 project_item"
                         data-id= <?= $project['id'] ?>
                    >
                        ...
                        <?php foreach ($projectUploads as $upload): ?>
                            ...
                            <a href="<?= $upload['image'] ?>" class="<?= ($i == 0) ? 'd-block' : 'd-none' ?>">
                                ...
                                <div class="project_foot">
                                    ...
                                    <div class="project_foot_right">
                                        <?php if (isset($project['logo']) && !empty($project['logo'])): ?>
                                            <img class="" src="<?= yii::getAlias('@web') . $project['logo'] ?>"
                                                 alt="">
                                        <?php endif; ?>
                                    </div>
                                </div>
                ...
                <?php if (count($data[1]['Commercial Projects']) > 6) : ?>
