...
return [
    ...
    'Create product category' => 'Создать категорию продукта',
    'Edit product category' => 'Изменить категорию продукта',
    ...
    'Category' => 'Категория',
    'Carousel name' => 'Название карусели',
    'Carousel' => 'Карусель',
    'Clients' => 'Клиенты',
    'Content' => 'Контентъ',
    'Clear image' => 'Очистить изображение',
    'Category name' => 'Kатегории',
    'Image cleared' => 'Изображение очищено',
    'Home page video' => 'Видео на главной',


    'mailaddresses' => 'Mail addresses',
    'Technical name' => '12Mail',
