    ...
    <table class="table table-hover">
        ...
        <?php foreach($data->models as $item) : ?>
            <tr data-id="<?= $item->primaryKey ?>">
                ...
                <?php endif; ?>
                <td><a href="<?= Url::to(['/admin/'.$module.'/a/edit', 'id' => $item->primaryKey]) ?>"><img src="<?= yii::getAlias('@web') . $item->thumb ?>" ></a></td>
                <td class="status vtop">
                    <?= Html::checkbox('', $item->status == Media::STATUS_ON, [
                        'class' => 'switch',
