 ...
 *
 * @method static BlogObject get(mixed $id_slug) Get page object by id or slug
 */
...
class Page extends \yii\easyii\components\API
{
    ...
    private function findPage($id_slug)
    {
        ...
        return $page ? new BlogObject($page) : $this->notFound($id_slug);
    }
