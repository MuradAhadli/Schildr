...
class PageBlockChildObject extends \yii\easyii\components\ApiObject
{
    public $slug;
    public $image;
    public $views;
    ...
    public function getPhotos()
    {
        if(!$this->_photos){
            ...
            foreach(Photo::find()->where(['class' => PageBlockChildModel::className(), 'item_id' => $this->id])->sort()->all() as $model){
    ...
    public function  getEditLink(){
        return Url::to(['/admin/pageblockchild/a/edit/', 'id' => $this->id]);
    }
}